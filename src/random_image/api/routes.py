...
async def get_random_image(params: ImageRequestParams = Depends(get_image_params)):
    """
    获取一张随机图片
    ...
    try:
        ...
        return JSONResponse(
            ...
            content=APIResponse(
                success=False, message=e.message, error_code=e.error_code
            ).__dict__,
        )
...
async def get_statistics():
    ...
    try:
        ...
        return APIResponse(success=True, data=stats, message="统计信息获取成功")
    except Exception as e:
        logger.error(f"获取统计信息失败: {e}")
        return APIResponse(
            success=False, message="获取统计信息失败", error_code="STATS_ERROR"
        )
...
async def refresh_images():
    ...
    try:
        ...
        return APIResponse(
            success=False, message="刷新图片列表失败", error_code="REFRESH_ERROR"
        )
...
async def health_check():
    ...
    try:
        ...
        return APIResponse(
            success=True, data=health_status.__dict__, message="服务运行正常"
        )
    except Exception as e:
        logger.error(f"健康检查失败: {e}")
        return APIResponse(
            success=False, message="服务状态异常", error_code="HEALTH_CHECK_ERROR"
        )
...
async def get_system_info():
    ...
    try:
        ...
        return APIResponse(success=True, data=info, message="系统信息获取成功")
    except Exception as e:
        logger.error(f"获取系统信息失败: {e}")
        return APIResponse(
            success=False, message="获取系统信息失败", error_code="INFO_ERROR"
        )
